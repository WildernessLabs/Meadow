...
enum espcp_wi_fi_function
{
    ...
    espcp_wi_fi_function_set_antenna = 5,
    espcp_wi_fi_function_socket = 6,
    espcp_wi_fi_function_connect = 7,
    espcp_wi_fi_function_write = 8,
    espcp_wi_fi_function_set_sock_opt = 9,
    espcp_wi_fi_function_read = 10,
    espcp_wi_fi_function_close = 11,
    espcp_wi_fi_function_send_to = 12,
    espcp_wi_fi_function_recv_from = 13,
    espcp_wi_fi_function_poll = 14,
    espcp_wi_fi_function_interrupt_poll_response = 15,
    espcp_wi_fi_function_send = 16,
    espcp_wi_fi_function_bind = 17,
    espcp_wi_fi_function_listen = 18,
    espcp_wi_fi_function_accept = 19,
    espcp_wi_fi_function_ioctl = 20,
    espcp_wi_fi_function_get_sock_name = 21,
    espcp_wi_fi_function_get_peer_name = 22,
    espcp_wi_fi_function_free_addr_info = 23,
    espcp_wi_fi_function_get_addr_info = 24,
    espcp_wi_fi_function_start_wi_fi_interface_event = 25,
    espcp_wi_fi_function_stop_wi_fi_interface_event = 26,
    espcp_wi_fi_function_connect_to_access_point_event = 27,
    espcp_wi_fi_function_disconnect_from_access_point_event = 28,
    espcp_wi_fi_function_set_time_of_day_event = 29
};
