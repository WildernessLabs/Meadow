...
/*
 * Used when cross-compiling THUMB on a 64-bit platform
 */
#ifdef TARGET_ARM
...
DECL_OFFSET2(MonoClass,interfaces,84)
DECL_OFFSET2(MonoClass,sizes,88)
DECL_OFFSET2(MonoClass,fields,92)
DECL_OFFSET2(MonoClass,methods,96)
DECL_OFFSET2(MonoClass,this_arg,100)
DECL_OFFSET2(MonoClass,_byval_arg,108)
DECL_OFFSET2(MonoClass,gc_descr,116)
DECL_OFFSET2(MonoClass,runtime_info,120)
DECL_OFFSET2(MonoClass,vtable,124)
DECL_OFFSET2(MonoClass,infrequent_data,128)
DECL_SIZE2(MonoVTable,40)
...
DECL_OFFSET2(MonoVTable,flags,26)
DECL_OFFSET2(MonoVTable,imt_collisions_bitmap,28)
DECL_OFFSET2(MonoVTable,runtime_generic_context,32)
DECL_OFFSET2(MonoVTable,interp_vtable,36)
DECL_OFFSET2(MonoVTable,vtable,40)
...
DECL_SIZE2(MonoInternalThread,168)
...
DECL_OFFSET2(MonoInternalThread,current_appcontext,64)
DECL_OFFSET2(MonoInternalThread,root_domain_thread,68)
DECL_OFFSET2(MonoInternalThread,_serialized_principal,72)
DECL_OFFSET2(MonoInternalThread,_serialized_principal_version,76)
DECL_OFFSET2(MonoInternalThread,appdomain_refs,80)
DECL_OFFSET2(MonoInternalThread,__interruption_requested,84)
DECL_OFFSET2(MonoInternalThread,longlived,88)
DECL_OFFSET2(MonoInternalThread,threadpool_thread,92)
DECL_OFFSET2(MonoInternalThread,thread_interrupt_requested,93)
DECL_OFFSET2(MonoInternalThread,stack_size,96)
DECL_OFFSET2(MonoInternalThread,apartment_state,100)
DECL_OFFSET2(MonoInternalThread,critical_region_level,104)
DECL_OFFSET2(MonoInternalThread,managed_id,108)
DECL_OFFSET2(MonoInternalThread,small_id,112)
DECL_OFFSET2(MonoInternalThread,manage_callback,116)
DECL_OFFSET2(MonoInternalThread,flags,120)
DECL_OFFSET2(MonoInternalThread,thread_pinning_ref,124)
DECL_OFFSET2(MonoInternalThread,__abort_protected_block_count,128)
DECL_OFFSET2(MonoInternalThread,priority,132)
DECL_OFFSET2(MonoInternalThread,owned_mutexes,136)
DECL_OFFSET2(MonoInternalThread,suspended,140)
DECL_OFFSET2(MonoInternalThread,self_suspended,144)
DECL_OFFSET2(MonoInternalThread,thread_state,148)
DECL_OFFSET2(MonoInternalThread,unused,152)
...
DECL_SIZE2(MonoComInteropProxy,48)
...
DECL_SIZE2(SgenThreadInfo,828)
DECL_OFFSET2(SgenThreadInfo,client_info,0)
DECL_OFFSET2(SgenThreadInfo,tlab_start,804)
DECL_OFFSET2(SgenThreadInfo,tlab_next,808)
DECL_OFFSET2(SgenThreadInfo,tlab_temp_end,812)
DECL_OFFSET2(SgenThreadInfo,tlab_real_end,816)
DECL_OFFSET2(SgenThreadInfo,total_bytes_allocated,820)
DECL_SIZE2(SgenClientThreadInfo,804)
...
DECL_OFFSET2(SgenClientThreadInfo,runtime_data,588)
DECL_OFFSET2(SgenClientThreadInfo,stack_end,592)
DECL_OFFSET2(SgenClientThreadInfo,stack_start,596)
DECL_OFFSET2(SgenClientThreadInfo,stack_start_limit,600)
DECL_OFFSET2(SgenClientThreadInfo,ctx,604)
DECL_SIZE2(MonoProfilerCallContext,216)
DECL_OFFSET2(MonoProfilerCallContext,context,0)
DECL_OFFSET2(MonoProfilerCallContext,interp_frame,200)
DECL_OFFSET2(MonoProfilerCallContext,method,204)
DECL_OFFSET2(MonoProfilerCallContext,return_value,208)
DECL_OFFSET2(MonoProfilerCallContext,args,212)
...
DECL_SIZE2(MonoMethodRuntimeGenericContext,8)
...
DECL_SIZE2(MonoJitTlsData,1108)
...
DECL_OFFSET2(MonoJitTlsData,resume_state,252)
DECL_OFFSET2(MonoJitTlsData,handler_block,676)
DECL_OFFSET2(MonoJitTlsData,handler_block_context,680)
DECL_OFFSET2(MonoJitTlsData,orig_ex_ctx,880)
DECL_OFFSET2(MonoJitTlsData,orig_ex_ctx_set,1080)
DECL_OFFSET2(MonoJitTlsData,thrown_exc,1084)
DECL_OFFSET2(MonoJitTlsData,thrown_non_exc,1088)
DECL_OFFSET2(MonoJitTlsData,calling_image,1092)
DECL_OFFSET2(MonoJitTlsData,abort_exc_stack_threshold,1096)
DECL_OFFSET2(MonoJitTlsData,active_jit_methods,1100)
DECL_OFFSET2(MonoJitTlsData,interp_context,1104)
...
DECL_SIZE2(MonoContinuation,36)
...
DECL_SIZE2(MonoDelegateTrampInfo,36)
