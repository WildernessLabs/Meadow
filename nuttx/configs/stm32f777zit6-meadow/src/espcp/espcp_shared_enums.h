...
{
    espcp_wi_fi_function_connect_to_access_point = 0,
    espcp_wi_fi_function_connect_to_default_access_point = 1,
    espcp_wi_fi_function_clear_default_access_point = 2,
    ...
    espcp_wi_fi_function_get_sock_opt = 10,
    ...
    espcp_wi_fi_function_recv_msg = 26,
    espcp_wi_fi_function_shutdown = 27,
    espcp_wi_fi_function_send_msg = 28,
    espcp_wi_fi_function_dup2 = 29,
    espcp_wi_fi_function_add_ref = 30,
    espcp_wi_fi_function_sock_caps = 31,
    espcp_wi_fi_function_network_connected_event = 32,
    espcp_wi_fi_function_network_disconnected_event = 33,
    espcp_wi_fi_function_error_event = 34,
    espcp_wi_fi_function_ntp_update_event = 35
};
